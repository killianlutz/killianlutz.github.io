...
I lean towards JAX to quickly implement <span style="color:#800080">proofs of concept</span> by leveraging its <span style="color:#800080">automatic differentiation</span> capabilities and seamlessly carry computations on GPUs. For the past three years I have supervised practical sessions on scientific computing in Python for Master 2 students. 
