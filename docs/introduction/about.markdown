...
Keywords: Time minimal, Bilinear control, Lindblad, Parametric resonance, Reduced models

### <span style="color:#e67e22"> PhD project </span>

I work under the supervision of [Emmanuel Franck](https://irma.math.unistra.fr/~franck/index.html) and [Yannick Privat](https://yannick-privat.perso.math.cnrs.fr) and closely <span style="color:#800080">collaborate with physicists</span> of the group [Q-Dyno](https://www.ipcms.fr/en/equipe/theoretical-quantum-dynamics-of-nano-objects-dyno/) at IPCMS.
