...
On a daily basis I use Julia as my go-to language, both for building complex <span style="color:#800080">educational animations</span> using Makie and in my research to solve <span style="color:#800080">non-linear control</span> problems in the optimize-then-discretize paradigm.
